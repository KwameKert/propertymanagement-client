...
@NgModule({
  declarations: [AdminComponent, ListAllPropertyComponent, AddUserComponent, ListUserComponent, PropertyLocationsComponent, AddPropertyComponent, AddPropertyOwnerComponent, AddOwnerComponent, ListOwnerComponent, ],
  imports: [
    CommonModule,
    SharedModule,
    AdminRoutingModule,
